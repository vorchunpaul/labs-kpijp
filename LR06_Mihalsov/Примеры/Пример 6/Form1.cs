...
namespace Пример_6
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                label5.Text = "Максимальный размер массива, должен быть БОЛЬШЕ минимального ";
                button1.Enabled = true;
                return;
            }

            if((numericUpDown2.Value - numericUpDown1.Value) % numericUpDown3.Value != 0)
            {
                label5.Text = "Шаг должен быть кратен разности \nмаксимального и минимального значения";
                return;
            }

            if (numericUpDown4.Value < numericUpDown5.Value)
            {
                label5.Text = "Макс значение не м.б. меньше мин значения!";
                button1.Enabled = true;
                return;
            }
            ...
            Convert.ToInt32(numericUpDown3.Value))
            {
                ...
                for (int j = 0; j < n; j++)
                {
                    ...
                    (numericUpDown5.Value), Convert.ToInt32(numericUpDown4.Value));
                }
        ...
        private void sort(int[] p, int n)
        {
            ...
            label5.Text = "Количество сравнений=" +  Convert.ToString(sr) + " Количество обменов=" + Convert.ToString(obm);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < n; i++)
            {
                ...
                {
                    ptr[i, j] =
                    rand.Next(Convert.ToInt32(numericUpDown8.Value), Convert.ToInt32(numericUpDown7.Value));
            ...
            if (k == n)
            {
                label18.Text = "В матрице удалены все строки";
                return;
            }

            if (k == 0)
            {
                label18.Text = "В матрице нет удаленных строк";
                return;
            }

            label18.Text = "В матрице удалено " + k + " строк(и)";
            for (j = 0; j < m; j++)
            {
                ptr[n - k, j] = 0;
                for (i = 0; i < n - k; i++)
